...
def empty_cache(device_str=''):
    ...
    elif 'mps' in device_str and hasattr(torch.backends, 'mps'):
...
def init_vlm_model(vlm_config, from_weight='pretrain_vlm', tokenizer_path='../model', 
    ...
    if vlm_config.keep_ratio < 1.0:
        Logger(f'Token Pruning: strategy={vlm_config.pruning_strategy}, keep_ratio={vlm_config.keep_ratio}, visual_tokens={vlm_config.num_visual_tokens}/196')
